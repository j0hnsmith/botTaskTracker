  ...
  _ = ({ include: e = /.*/, exclude: t = /(?!)/ } = {}, n = X) => {
    ...
    for (; i.length; ) {
      ...
      for (let l in a) {
        ...
        U(a[l])
          ? i.push([a[l], `${u}.`])
          : r.test(u) && !s.test(u) && o.push([u, oe(u)])
      }
    }
    return Me(o)
  },
...
var nn = (e = document.documentElement, t = !0) => {
    ;(K(e) && _e([e], !0),
      ...
      t &&
        (en.observe(e, { subtree: !0, childList: !0, attributes: !0 }),
        Zt.add(e)))
  },
  xt = (e, t, n, r) => {
    {
      ...
      switch (e.type) {
        ...
        case 'radio':
          ;(e.getAttribute('name')?.length || e.setAttribute('name', o),
            (i = (f, m) =>
              f.checked ? (m === 'number' ? +f.value : f.value) : Ct),
            (a = (f) => {
  ...
  apply({ el: e, mods: t, rx: n }) {
    ...
    t.has('full')
      ...
      : t.has('half')
        ? (s.threshold = 0.5)
        : t.get('threshold') &&
          (s.threshold = Ot(Number(t.get('threshold')), 0, 100) / 100)
    let o = t.has('exit'),
...
p({
  ...
  apply({ el: e, rx: t }) {
    let n = () => {
        ;(r.disconnect(),
          t()
            ? e.style.display === kt && e.style.removeProperty(Ht)
            : e.style.setProperty(Ht, kt),
...
var Te = G('ignore-morph'),
  ...
  yn = (e, t, n = 'outer') => {
    if (
      (K(e) && K(t) && e.hasAttribute(Te) && t.hasAttribute(Te)) ||
    ...
    ;(e instanceof Element &&
      e.id &&
      (le.has(e.id) ? Se.add(e.id) : le.set(e.id, e.tagName)),
      ue.clear())
    ...
    ;(qt(i, s),
      qt(r, o),
      Gt(i, r, n === 'outer' ? e : null, e.nextSibling),
      fe.remove())
  },
  ...
  bn = (e, t, n) => {
    ...
    for (; c && c !== n; ) {
      ...
      ;(r === null &&
        s &&
        It(c, s) &&
        (o++, (s = s.nextSibling), o >= 2 && (r = void 0)),
        (c = c.nextSibling))
    }
    return r || null
  },
